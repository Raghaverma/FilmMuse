        ...
        >
          <div className="flex items-center">
                  ...
                  {userProfile.photoURL ? (
                    <Image
                      ...
                      onError={(e) => {
                        ...
                        if (parent) {
                          parent.innerHTML = `<div class="w-full h-full flex items-center justify-center text-emerald-400 font-bold text-lg">${userProfile.username.charAt(0).toUpperCase()}</div>`;
                        }
                      }}
                    />
                  ) : (
            ...
            <div className="flex-1">
              <div className="flex items-center">
                <h2 className="text-xl font-bold text-neutral-900 dark:text-white">{userProfile.username}</h2>
                <motion.div
              ...
              <p className="text-neutral-500 dark:text-neutral-400 text-sm">
                FilmMuse User • {userProfile.email}
              </p>
            </div>
            <motion.button
            ...
            >
              <div className="p-6 border-b border-neutral-200 dark:border-neutral-700">
                ...
                >
                  <div className="flex justify-between mb-16">
                    <div className={resolvedTheme === "light" ? "text-neutral-800" : "text-white"}>
                      <svg
                        fill="currentColor"
                        width="30px"
                        height="30px"
                  ...
                  <div className="flex items-center mb-4">
                    <div className={`font-mono ${resolvedTheme === "light" ? "text-neutral-800" : "text-white"}`}>
                      {userProfile.username}
                    </div>
                    <div className={`ml-auto font-mono ${resolvedTheme === "light" ? "text-neutral-800" : "text-white"}`}>
                      {displayStats.watchlist}/{displayStats.liked}
                    </div>
                  </div>

                  <div
                    className={`font-mono text-xl tracking-widest ${resolvedTheme === "light" ? "text-neutral-800" : "text-white"}`}
                  >
                    {displayStats.lists} {displayStats.rated} {displayStats.watchlist} {displayStats.liked}
                  </div>
                </motion.div>
              </div>
              ...
              <div className="p-4 flex items-center justify-between hover:bg-neutral-50 dark:hover:bg-neutral-900 transition-colors duration-200">
                <div className="flex items-center">
                  ...
                  <span className="text-neutral-900 dark:text-white font-medium">FilmMuse</span>
                </div>
                <div className="text-neutral-500 dark:text-neutral-400 text-sm">v1.0</div>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
